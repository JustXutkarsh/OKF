"""Read-only access to the OKF bundle.
...
This module never writes, never caches, never preloads bodies, and never
touches validation or producer code. Consumer A is read-only by design.
"""
...
from consumer_a.exceptions import ConfigError, DocumentReadError, FilesystemError
...
def scan_catalog(bundle_path: Path) -> list[CatalogEntry]:
    ...
    Consumer A reports problems instead of guessing around them.
    """
