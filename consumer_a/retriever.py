...
tunable, testable scoring. Each scoring signal is an independent function;
the total is a plain sum. Every candidate's per-signal breakdown is
returned for later tuning. Ties break on concept id, so identical
questions always produce identical selections.
"""
...
from consumer_a.models import CatalogEntry, RankingEntry, RetrievalResult
