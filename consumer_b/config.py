"""Independent configuration loader for Consumer B.

Same convention as the other components (process env > .env dev fallback
> defaults) but deliberately a separate module: Consumer B shares nothing
with producer, validator, or Consumer A except the okf/ directory.

Provider and model are fully environment-driven:
...
from consumer_b.exceptions import ConfigError
from consumer_b.models import ConsumerConfig
...
ENV_PROVIDER = "OKF_CONSUMER_B_PROVIDER"
ENV_MODEL = "OKF_CONSUMER_B_MODEL"
ENV_MAX_DOCS = "OKF_CONSUMER_B_MAX_DOCS"
...
def load_config(
    ...
    """Assemble Consumer B configuration from env, optional .env, defaults."""
